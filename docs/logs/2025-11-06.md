...
- **Integration Notes**
  ...
  - Provide interop helpers for legacy APIs that still expect `Chunk[Byte]` or raw numeric sizes.
...
- **Test Plan**
  - Unit: constructor success/failure cases, conversions to/from primitives, interactions with `Tracked` updates.
