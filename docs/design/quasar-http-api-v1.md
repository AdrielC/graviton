...
- Automation features may only restrict access further, never widen it.
...
{
  "namespaces": {
    "urn:graviton:quasar:core": {
      "schema": "urn:graviton:schema:quasar-core@1.0.0",
      "id": "meta_01J...",
      "data": {
...
```json
{
  ...
  "externalRefs": [
    { "system": "legacy-dms", "value": "ABC123", "meta": { "repo": "shortterm" } }
  ],
  "initialMetadata": {
    "namespaces": {
      "urn:graviton:quasar:core": {
...
- `view=urn:graviton:view:ocrText@1`
...
```json
{
  ...
  "bundle": {
    "namespaces": {
      "urn:graviton:records:entities": {
        "schema": "urn:graviton:schema:records-entities@1.0.0",
        "id": "meta_01M...",
...
```json
{
  "schemaUrn": "urn:graviton:schema:records-case@1.2.0",
  "namespaceUrn": "urn:graviton:records:case",
  "lifecycle": "published",
  "jsonSchema": {
...
```json
{
  "fromSchemaUrn": "urn:graviton:schema:records-case@1.1.0",
  "toSchemaUrn": "urn:graviton:schema:records-case@1.2.0",
...
```json
{
  ...
  "filters": {
    "orgId": "washoe",
    "namespace": "urn:graviton:records:case",
    "docType": "motion"
  },
  "limit": 50,
  "cursor": null
...
- `urn:graviton:workflow:ocr@1`
- `urn:graviton:workflow:classify@1`
- `urn:graviton:workflow:redact@1`

```json
{
  "inputs": {
    "sourceVersion": "current",
    "targetNamespace": "urn:graviton:records:ocr",
    "options": { "language": "en" }
  }
}
```
...
```json
{
  ...
  "error": null,
  "outputs": {
    "derivedNamespaces": ["urn:graviton:records:ocr"],
    "viewKeys": ["v1:..."]
  }
}
```

## API: legacy repository integration (compat, not core)

### Import legacy doc (repo + legacyDocId)

`POST /v1/legacy/repository/import`
