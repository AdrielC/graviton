...
- `IngestPipeline.countHashRechunk` and `CasIngest.pipeline` now return explicit ZIO Blocks schema-backed summaries. Their Scala 3.8 suites are enabled and no longer depend on mixed-field dynamic Kyo Record access.
