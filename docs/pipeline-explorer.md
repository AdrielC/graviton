...
See [Transducer Algebra](./core/transducers.md) for the JVM implementation, the streaming-versus-collecting boundary, and the explicit schema-backed aggregate summaries.
