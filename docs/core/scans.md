...
- `graviton.core.scan.Scan` — a **direct** stateful transducer you can compose and run (including as a `ZPipeline`).
...
- **[Transducer Algebra](./transducers.md)** for implemented composition APIs
