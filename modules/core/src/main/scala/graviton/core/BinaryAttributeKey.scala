...
object BinaryAttributeKey:
  ...
  inline given [NS <: Name, N <: Name] => (NS: ValueOf[NS], N: ValueOf[N]) => ValueOf[AddNameSpace[NS, N]] =
  ...
  transparent trait NamespacedKey[NameSpace <: Name & Singleton](
    ...
    transparent inline def applyDynamic[V, N <: Name & Singleton, P <: (NoPrefix | Name)](schema: Schema[V]): Aux[V, N, ToPrefix[P]] =
    ...
    inline transparent final def fileName    = selectDynamic[String]("fileName")
    inline transparent final def contentType = selectDynamic[String]("contentType")
    inline transparent final def forks       = selectDynamic[Int]("forks")
    inline transparent final def version     = selectDynamic[String]("version")
    inline transparent final def build       = selectDynamic[String]("build")
    inline transparent final def buildFp     = selectDynamic[String]("buildFp")
    inline transparent final def buildH      = selectDynamic[String]("buildH")
    inline transparent final def buildImplId = selectDynamic[String]("buildImplId")
