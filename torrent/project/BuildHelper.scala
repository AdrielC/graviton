...
object BuildHelper {
  ...
  val gitServer = sys.env.getOrElse("GIT_SERVER", "git.tybera.net")
  val gitProtocol = sys.env.getOrElse("GIT_PROTOCOL", "http")
  val gitBaseUrl = s"$gitProtocol://$gitServer"

  private lazy val versions: Map[String, String] = {
